...
다음 텍스트 문서에는 이 [!DNL Experience Manager] 6.5 LTS, 서비스 팩 2 릴리스에 포함된 OSGi 번들과 콘텐츠 패키지가 나열되어 있습니다. <!-- UPDATE FOR EACH NEW RELEASE -->

* [Experience Manager 6.5 LTS, 서비스 팩 2에 포함된 OSGi 번들 목록](/help/release-notes/assets/65lts_sp2_bundles.txt) <!-- UPDATE FOR EACH NEW RELEASE -->
* [Experience Manager 6.5 LTS, 서비스 팩 2에 포함된 콘텐츠 패키지 목록](/help/release-notes/assets/65lts_sp2_packages.txt) <!-- UPDATE FOR EACH NEW RELEASE -->
