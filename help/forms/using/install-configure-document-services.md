...
* PDF Generator가 Microsoft® Windows 및 Linux®에서 변환을 수행하는 데 필요한 클라이언트 소프트웨어가 설치되어 있습니다.
   ...
   * **® Windows**: **Microsoft® Office** 또는 **Apache OpenOffice** 설치
...
* ® Office(32비트) 및 Adobe Acrobat의 [지원되는 버전](/help/sites-deploying/technical-requirements.md)만 설치되어 있고 대화 상자 열기를 취소했는지 확인하십시오.
...
* ® Visual C++ 2012 x86 및 Microsoft® Visual C++ 2013 x86(32비트) 재배포 가능 패키지가 Windows에 설치되어 있는지 확인합니다.
...
* 서버 로그를 확인하여 특정 사용자에 대한 변환이 실패하는지 확인합니다. (프로세스 탐색기를 통해 다른 사용자에 대한 실행 중인 프로세스를 확인할 수 있습니다.)
...
+++AEM Forms Server에 설치된 Adobe Acrobat 라이선스가 만료됨
