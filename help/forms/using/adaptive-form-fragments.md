...
<table>
 <tbody>
  ...
  <tr>
   <td><p>미리보기</p> </td>
   <td><p>XML 파일의 데이터를 조각과 병합하여 조각을 HTML 또는 사용자 지정 미리 보기로 미리 볼 수 있는 옵션을 제공합니다. 자세한 내용은 양식</a> 미리 보기를 참조하십시오<a href="/help/forms/using/previewing-forms.md" target="_blank">.<br /> <br /> </p> </td>
  </tr>
  <tr>
