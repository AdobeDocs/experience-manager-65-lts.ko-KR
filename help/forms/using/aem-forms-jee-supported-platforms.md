...
- **전체 설치 관리자에 대한 업그레이드 지원**: 전체 설치 관리자 기반 업그레이드는 AEM 6.5.23.0부터 지원됩니다.
...
>[!NOTE]
>
>추가 요구 사항은 [JEE 배포의 단일 서버 AEM Forms에 대한 시스템 요구 사항](https://helpx.adobe.com/content/dam/help/en/experience-manager/65LTS/forms/prepare-install-single-server.pdf)을 참조하십시오.
...
>[!NOTE]
>
>Acrobat DC 제품군은 Acrobat과 Reader에 대해 &quot;Classic&quot;과 &quot;Continuous&quot;의 두 가지 제품을 도입합니다.
...
<table>
 <tbody>
  ...
  <tr>
   <td><p>® Windows® 11(Enterprise, Pro, Basic)</p> <p>64비트 버전</p> <p> </p> </td>
   <td>서비스 팩 및 주요 업데이트</td>
  </tr>
  <tr>
...
>- Workspace은 Macintosh OS X 10.6 및 10.7에서 Safari 5.1(Acrobat DC 이상 버전 포함)을 지원합니다.
...
경우에 따라 Adobe은 주요 기능을 변경하는 서드파티 업데이트를 지원하지 않으므로 전체 이전 버전과의 호환성을 지원하지 않습니다.
