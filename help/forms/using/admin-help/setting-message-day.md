---
title: 오늘의 메시지 설정
description: 오늘의 메시지를 사용하면 Workspace 사용자 인터페이스의 시작 페이지에 표시될 메시지를 설정할 수 있습니다.
contentOwner: admin
...
Workspace 사용자 인터페이스의 시작 페이지에 표시될 메시지를 설정할 수 있습니다.
...
1. 관리 콘솔에서 서비스 > Workspace > 오늘의 메시지를 클릭합니다.
1. 오늘의 메시지 상자에 시작 화면에 표시될 텍스트를 입력합니다.
1. 저장을 클릭합니다.
