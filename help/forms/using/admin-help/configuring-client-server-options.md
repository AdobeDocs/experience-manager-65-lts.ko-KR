...
1. Document Security를 사용하여 AEM Forms 환경을 설치하고 구성한 후 사용자 관리에서 모든 적절한 도메인을 설정합니다. <!-- Fix broken link (See Setting up and managing domains) -->
...
이 예에서는 Microsoft PowerPoint 2007 또는 Microsoft PowerPoint 2010의 Microsoft Office용 Acrobat Reader DC 확장 설치 요청이 모두 거부됩니다.
...
### Document Security 문서에 대한 SOAP 엔드포인트 비활성화 {#disable-soap-endpoints-for-document-security-documents}

문서 보안 문서의 SOAP 끝점을 비활성화하도록 config.xml이 다음과 같이 변경되었습니다.
