...
Acrobat Reader DC 확장 기능 관련 정보와 지침은 [Acrobat Reader DC 확장 기능과 함께 사용할 자격 증명 구성](/help/forms/using/admin-help/configuring-credentials-acrobat-reader-dc.md#configuring-credentials-for-use-with-acrobat-reader-dc-extensions)을 참조하십시오.
...
1. 가져오기를 클릭합니다. Trust Store Type에서 다음 옵션 중 하나를 선택합니다.
   ...
   * **Acrobat Reader DC 확장 프로그램 자격 증명:** 제작된 PDF 문서에서 Adobe Reader 사용 권한을 활성화할 수 있는 Acrobat Reader DC 확장 프로그램 관련 디지털 인증서입니다.
