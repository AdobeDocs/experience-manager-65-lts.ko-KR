...
이러한 설정은 Adobe LiveCycle ES 2.5 이전 버전에서 업그레이드한 경우에만 표시됩니다.
...
**client_pollingInterval:** (JEE의 AEM Forms에서 더 이상 사용되지 않음) Flex Workspace에서 새 작업 및 수정된 작업을 검색하는 데 사용되는 폴링 간격(초)을 설정합니다. 기본값은 3초입니다. AEM Forms Workspace에서는 작동하지 않습니다.
