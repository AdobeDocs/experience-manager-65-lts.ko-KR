...
+ 릴리스 정보 {#release-notes}
   + [최신](/help/release-notes/release-notes.md)
   + 이전 릴리스 정보 {#service-pack}
      + [6.5.1](/help/release-notes/previous/6-5-1-lts.md)
      + [GA](/help/release-notes/previous/ga.md)
   + [자주 묻는 질문](/help/release-notes/faq.md)
   + [기술 FAQ](/help/release-notes/technical-faq.md)
+ 보안 {#security}
...
+ Forms {#forms}
   ...
   + AEM Forms 관리 {#manage-administer-aem-forms}
      ...
      + 사용자 데이터 처리 {#handling-user-data}
         + {hide-from-toc}[OSGi의 Forms 중심 워크플로](/help/forms/using/forms-workflow-osgi-handling-user-data.md)
         + [Forms 사용자 관리](/help/forms/using/user-management-handling-user-data.md)
         + {hide-from-toc}[Forms JEE 워크플로](/help/forms/using/forms-workflow-jee-handling-user-data.md)
      ...
      + AEM Forms 환경 강화 {#hardening-aem-forms-environment}
         ...
         + {hide-from-toc}[JEE의 AEM Forms에 대한 일반 보안 고려 사항](/help/forms/using/general-security-considerations.md)
         + {hide-from-toc}[JEE 환경에서 AEM Forms 강화](/help/forms/using/hardening-aem-forms-jee-environment.md)
         + {hide-from-toc}[JEE에서 AEM Forms에 대한 보안 관리 설정 구성](/help/forms/using/configuring-secure-administration-settings-aem.md)
   ...
   + AEM Forms 앱 {#aem-forms-app}
      ...
      + [™ studio 프로젝트 설정 및 Android™ 앱 빌드](/help/forms/using/setup-android-studio-project-build-installer.md)
   ...
   + JEE의 AEM Forms에 대한 관리자 도움말 {#administrator-help}
      + 시작하기 {#get-started}
         + {hide-from-toc}[일반 AEM Forms 설정](/help/forms/using/admin-help/configure-general-aem-forms-settings.md)
         + {hide-from-toc}[배포에 대한 라이선스 유형 업데이트](/help/forms/using/admin-help/update-license-type-deployment.md)
      + 도메인 설정 및 관리 {#setup-manage-domains}
         + {hide-from-toc}[도메인 추가](/help/forms/using/admin-help/adding-domains.md)
         + {hide-from-toc}[도메인 삭제](/help/forms/using/admin-help/delete-domain.md)
         + {hide-from-toc}[계정 잠금 설정 구성](/help/forms/using/admin-help/configure-account-locking-settings.md)
         + {hide-from-toc}[기존 도메인 편집 및 변환](/help/forms/using/admin-help/editing-converting-existing-domains.md)
         + {hide-from-toc}[인증 공급자 구성](/help/forms/using/admin-help/configuring-authentication-providers.md)
         + {hide-from-toc}[디렉터리 동기화](/help/forms/using/admin-help/synchronizing-directories.md)
         + {hide-from-toc}[디렉터리 구성](/help/forms/using/admin-help/configuring-directories.md)
      + 사용자 관리 구성 {#configure-user-management}
         + {hide-from-toc}[인증에 대한 평가 순서 변경](/help/forms/using/admin-help/change-order-evaluation-authentication.md)
         + {hide-from-toc}[LDAP 바인딩 암호 구성](/help/forms/using/admin-help/configure-ldap-bind-password.md)
         + {hide-from-toc}[도메인 정보를 미리 가져오도록 AEM Forms 구성](/help/forms/using/admin-help/configure-aem-forms-prefetch-domain.md)
         + {hide-from-toc}[인증서 기반 인증 구성](/help/forms/using/admin-help/configuring-certificate-based-authentication.md)
         + {hide-from-toc}[SAML 서비스 공급자 설정 구성](/help/forms/using/admin-help/configure-saml-service-provider-settings.md)
         + {hide-from-toc}[AEM 양식에서 SSO(Single Sign-On) 사용](/help/forms/using/admin-help/enabling-single-sign-on-aem.md)
         + {hide-from-toc}[SSL 사용 LDAP 서버에 대한 사용자 관리 구성](/help/forms/using/admin-help/configure-user-management-ssl-enabled.md)
         + {hide-from-toc}[구성 파일 가져오기 및 내보내기](/help/forms/using/admin-help/importing-exporting-configuration-file.md)
         + {hide-from-toc}[고급 시스템 특성 구성](/help/forms/using/admin-help/configure-advanced-system-attributes.md)
         + {hide-from-toc}[CSRF 공격 방지](/help/forms/using/admin-help/preventing-csrf-attacks.md)
      + 사용자 설정 및 구성 {#setup-organize-users}
         + {hide-from-toc}[사용자 추가 및 구성](/help/forms/using/admin-help/adding-configuring-users.md)
         + {hide-from-toc}[적시 사용자 프로비저닝](/help/forms/using/admin-help/just-in-time-user-provisioning.md)
         + {hide-from-toc}[그룹 만들기 및 구성](/help/forms/using/admin-help/creating-configuring-groups.md)
         + {hide-from-toc}[사용자 또는 그룹 검색](/help/forms/using/admin-help/search-user-or-group.md)
         + {hide-from-toc}[역할 만들기 및 구성](/help/forms/using/admin-help/creating-configuring-roles.md)
      + 콘텐츠 관리 시스템에 연결 {#connect-content-management-system}
         + {hide-from-toc}[EMC Documentum용 커넥터 구성®](/help/forms/using/admin-help/configuring-connector-emc-documentum.md)
         + {hide-from-toc}[® FileNet용 커넥터 구성](/help/forms/using/admin-help/configuring-connector-ibm-filenet.md)
         + {hide-from-toc}[® Content Manager용 커넥터 구성](/help/forms/using/admin-help/configuring-connector-ibm-content-manager.md)
         + {hide-from-toc}[Microsoft SharePoint에 대한 커넥터 구성](/help/forms/using/admin-help/configuring-connector-microsoft-sharepoint.md)
      + 인증서 및 자격 증명 관리 {#manage-certificates-credentials}
         + {hide-from-toc}[사용자 이름 및 암호 자격 증명 추가 및 제거](/help/forms/using/admin-help/adding-removing-user-name-password.md)
         + {hide-from-toc}[인증서 해지 목록 관리](/help/forms/using/admin-help/certificate-revocation-lists.md)
         + {hide-from-toc}[인증서 및 자격 증명 관리의 기본 사항](/help/forms/using/admin-help/overview-2.md)
         + {hide-from-toc}[인증서 관리](/help/forms/using/admin-help/certificates.md)
         + {hide-from-toc}[HSM 자격 증명 관리](/help/forms/using/admin-help/hsm-credentials.md)
         + {hide-from-toc}[로컬 자격 증명 관리](/help/forms/using/admin-help/local-credentials.md)
      + 애플리케이션 및 아카이브 가져오기 및 관리 {#import-manage-applications-archives}
         + {hide-from-toc}[응용 프로그램 및 서비스 페이지에 표시되는 항목 수를 변경합니다](/help/forms/using/admin-help/change-number-items-displayed-applications.md)
         + {hide-from-toc}[아카이브 가져오기 및 관리](/help/forms/using/admin-help/import-archives.md)
         + {hide-from-toc}[응용 프로그램 가져오기 및 관리](/help/forms/using/admin-help/import-applications.md)
      + 서비스 관리 {#manage-services}
         + {hide-from-toc}[서비스 설정 구성](/help/forms/using/admin-help/configure-service-settings.md)
         + {hide-from-toc}[서비스 시작 및 중지](/help/forms/using/admin-help/starting-stopping-services.md)
      + 엔드포인트 관리 {#manage-endpoints}
         + {hide-from-toc}[끝점 추가, 활성화, 수정 또는 제거](/help/forms/using/admin-help/adding-enabling-modifying-or-removing.md)
         + {hide-from-toc}[전자 메일 끝점 구성](/help/forms/using/admin-help/configuring-email-endpoints.md)
         + {hide-from-toc}[oAuth2.0 인증 구성](/help/forms/using/oauth2-support-for-mail-service.md)
         + {hide-from-toc}[원격 끝점 구성](/help/forms/using/admin-help/configuring-remoting-endpoints.md)
         + {hide-from-toc}[감시 폴더 끝점 구성](/help/forms/using/admin-help/configuring-watched-folder-endpoints.md)
         + {hide-from-toc}[작업 관리자 끝점 구성](/help/forms/using/admin-help/configuring-task-manager-endpoints.md)
         + {hide-from-toc}[끝점 유형](/help/forms/using/admin-help/types-endpoints.md)
      + Acrobat Reader DC 확장 구성 {#configure-acrobat-reader-dc-extensions}
         + {hide-from-toc}[Acrobat Reader DC 확장에서 사용하는 인증서 유형](/help/forms/using/admin-help/certificate-types-used-acrobat-reader.md)
         + {hide-from-toc}[PDF 문서에서 유효하고 만료된 인증서 인식](/help/forms/using/admin-help/recognizing-valid-expired-certificates-pdf.md)
         + {hide-from-toc}[데이터 캡처를 위한 Acrobat Reader DC 확장 구성](/help/forms/using/admin-help/configuring-acrobat-reader-dc-extensions.md)
         + {hide-from-toc}[자격 증명 사용 정보 검토](/help/forms/using/admin-help/review-credential-information.md)
         + {hide-from-toc}[Acrobat Reader DC 확장에 사용할 자격 증명 구성](/help/forms/using/admin-help/configuring-credentials-acrobat-reader-dc.md)
         + {hide-from-toc}[PDF 파일의 사용 권한 검토](/help/forms/using/admin-help/review-usage-rights-pdf-file.md)
         + {hide-from-toc}[Adobe Reader 웹 브라우저 플러그인에 대한 온라인 댓글 달기 사용](/help/forms/using/admin-help/enabling-online-commenting-reader-web.md)
         + {hide-from-toc}[Acrobat Reader DC 확장에 사용할 시간 제한 값 설정](/help/forms/using/admin-help/setting-timeout-values-acrobat-reader.md)
         + {hide-from-toc}[만료된 Reader 확장 서비스 인증서 업데이트](/help/forms/using/admin-help/updating-expired-reader-extension-certificates.md)
      + PDF Generator 작업 {#work-with-pdf-generator}
         + {hide-from-toc}[PDF Generator 작업 소개](/help/forms/using/admin-help/overview-5.md)
         + {hide-from-toc}[다중 스레드 파일 변환 사용](/help/forms/using/admin-help/enabling-multi-threaded-file-conversions.md)
         + {hide-from-toc}[Adobe PDF 설정 구성](/help/forms/using/admin-help/configuring-pdf-settings.md)
         + {hide-from-toc}[보안 설정 구성](/help/forms/using/admin-help/configuring-security-settings.md)
         + {hide-from-toc}[파일 형식 설정을 구성하는 중](/help/forms/using/admin-help/configuring-file-type-settings.md)
         + {hide-from-toc}[PDF Generator 구성 파일 가져오기 및 내보내기](/help/forms/using/admin-help/importing-exporting-pdf-generator-configuration.md)
         + {hide-from-toc}[PDF/A 지원 사용](/help/forms/using/admin-help/enable-pdf-a-support.md)
         + {hide-from-toc}[PDFG 네트워크 프린터 설정(Windows에만 해당)](/help/forms/using/admin-help/setting-pdfg-network-printer-windows.md)
         + {hide-from-toc}[대체 글꼴 구성](/help/forms/using/admin-help/configuring-fallback-fonts.md)
         + {hide-from-toc}[PDF 내보내기 전환 설정 수정](/help/forms/using/admin-help/modifying-pdf-export-conversion-settings.md)
         + {hide-from-toc}[PDF Generator을 사용하여 파일 변환](/help/forms/using/admin-help/converting-files-using-pdf-generator.md)
      + SSL 구성 {#configure-ssl}
         + {hide-from-toc}[SSL 구성 개요](/help/forms/using/admin-help/overview-6.md)
         + [JBoss® 애플리케이션 서버에 대한 SSL 구성](/help/forms/using/admin-help/configuring-ssl-for-jboss-application-server-aem-forms-65-lts-jee.md)
         + {hide-from-toc}[Windows Vista에서 SSL 구성](/help/forms/using/admin-help/configuring-ssl-windows-vista.md)
         + {hide-from-toc}[WebSphere® 응용 프로그램 서버에 대한 SSL 구성](/help/forms/using/admin-help/configuring-ssl-websphere-application-server.md)
      + 문서 보안 작업 {#work-with-document-security}
         + {hide-from-toc}[문서 보안 정보](/help/forms/using/admin-help/document-security.md)
         + {hide-from-toc}[대량 보안 정보 배달](/help/forms/using/admin-help/high-volume-secure-information-delivery.md)
         + {hide-from-toc}[클라이언트 및 서버 옵션 구성](/help/forms/using/admin-help/configuring-client-server-options.md)
         + {hide-from-toc}[초대된 사용자 계정 및 로컬 사용자 계정 관리](/help/forms/using/admin-help/invited-local-user-accounts.md)
         + {hide-from-toc}[정책으로 보호된 문서에 대한 액세스 제어](/help/forms/using/admin-help/controlling-access-policy-protected-documents.md)
         + {hide-from-toc}[이벤트 모니터링](/help/forms/using/admin-help/monitoring-events.md)
         + {hide-from-toc}[정책 만들기 및 관리](/help/forms/using/admin-help/creating-policies.md)
         + {hide-from-toc}[문서 보안 웹 페이지 사용](/help/forms/using/admin-help/using-document-security-web-pages.md)
         + {hide-from-toc}[정책 집합 만들기 및 관리](/help/forms/using/admin-help/creating-policy-sets.md)
         + {hide-from-toc}[사용자로 등록](/help/forms/using/admin-help/registering-as-a-user.md)
      + 양식 구성 {#configure-forms}
         + {hide-from-toc}[양식 구성의 기본 사항](/help/forms/using/admin-help/overview-7.md)
         + {hide-from-toc}[다국어화 옵션 설정](/help/forms/using/admin-help/setting-internationalization-options.md)
         + {hide-from-toc}[Forms에 대한 캐싱 구성](/help/forms/using/admin-help/configuring-caching-forms.md)
         + {hide-from-toc}[XCI 구성 옵션 지정](/help/forms/using/admin-help/specifying-xci-configuration-options.md)
         + {hide-from-toc}[양식 출력 구성](/help/forms/using/admin-help/configuring-form-output.md)
         + {hide-from-toc}[포함할 글꼴 지정](/help/forms/using/admin-help/specifying-fonts-embed.md)
         + {hide-from-toc}[Forms에 대한 위치 구성](/help/forms/using/admin-help/configuring-locations-forms.md)
         + {hide-from-toc}[보안 설정 지정](/help/forms/using/admin-help/specifying-security-settings.md)
         + {hide-from-toc}[유효성 검사 메시지 구성](/help/forms/using/admin-help/configuring-validation-messages.md)
      + 출력 구성 {#configure-output}
         + {hide-from-toc}[출력 서비스 개요](/help/forms/using/admin-help/overview-8.md)
         + {hide-from-toc}[XCI 구성 옵션 지정](/help/forms/using/admin-help/specify-xci-configuration-options.md)
         + {hide-from-toc}[출력에 대한 캐싱 구성](/help/forms/using/admin-help/configuring-caching-output.md)
         + {hide-from-toc}[출력의 파일 위치 지정](/help/forms/using/admin-help/specify-file-locations-output.md)
         + {hide-from-toc}[사용할 수 있는 글꼴 만들기](/help/forms/using/admin-help/make-fonts-available.md)
         + {hide-from-toc}[포함할 글꼴 지정](/help/forms/using/admin-help/specify-fonts-embed.md)
         + {hide-from-toc}[보안 설정 지정](/help/forms/using/admin-help/specify-security-settings.md)
         + {hide-from-toc}[문자 집합 변경](/help/forms/using/admin-help/change-character-set.md)
      + Forms Workflow 구성{#configure-forms-workflow}
         + {hide-from-toc}[관리 및 프로세스 용어 정보](/help/forms/using/admin-help/administration-process-terminology.md)
         + {hide-from-toc}[프로세스 관리](/help/forms/using/admin-help/processes.md)
         + {hide-from-toc}[비즈니스 캘린더 구성](/help/forms/using/admin-help/configuring-business-calendars.md)
         + {hide-from-toc}[Forms Workflow 개요](/help/forms/using/admin-help/overview-9.md)
         + {hide-from-toc}[부재 설정 구성](/help/forms/using/admin-help/configuring-out-office-settings.md)
         + {hide-from-toc}[프로세스 인스턴스 검색](/help/forms/using/admin-help/searching-process-instances.md)
         + {hide-from-toc}[서버 설정 구성](/help/forms/using/admin-help/configuring-server-settings.md)
         + {hide-from-toc}[중단된 작업 및 분기 작업](/help/forms/using/admin-help/stalled-operations-branches.md)
         + {hide-from-toc}[공유 큐 구성](/help/forms/using/admin-help/configuring-shared-queues.md)
         + {hide-from-toc}[작업](/help/forms/using/admin-help/tasks.md)
      + Workspace 구성 {#configure-workspace}
         + {hide-from-toc}[Workspace 개요](/help/forms/using/admin-help/overview-10.md)
         + {hide-from-toc}[전역 설정 가져오기 및 내보내기](/help/forms/using/admin-help/importing-exporting-global-settings.md)
         + {hide-from-toc}[오늘의 메시지를 설정하는 중](/help/forms/using/admin-help/setting-message-day.md)
         + {hide-from-toc}[검색 템플릿 사용자 지정](/help/forms/using/admin-help/customizing-search-templates.md)
         + {hide-from-toc}[Workspace에 표시된 범주 관리](/help/forms/using/admin-help/categories-displayed-workspace.md)
      + 상태 모니터 {#health-monitor}
         + {hide-from-toc}[상태 모니터 개요](/help/forms/using/admin-help/overview-11.md)
         + {hide-from-toc}[상태 모니터 성능 조정](/help/forms/using/admin-help/fine-tuning-health-monitor-performance.md)
         + {hide-from-toc}[작업 관리자 관련 통계 보기](/help/forms/using/admin-help/view-statistics-related-manager.md)
         + {hide-from-toc}[시스템 정보 보기](/help/forms/using/admin-help/view-system-information.md)
         + {hide-from-toc}[작업 관리자 데이터베이스에서 레코드 제거](/help/forms/using/admin-help/purge-records-job-manager-database.md)
      + AEM Forms 유지 관리 {#maintain-aem-forms}
         + {hide-from-toc}[로그 파일](/help/forms/using/admin-help/log-files.md)
         + {hide-from-toc}[사용자 관리](/help/forms/using/admin-help/user-management.md)
         + {hide-from-toc}[AEM 양식 배포 모니터링](/help/forms/using/admin-help/monitoring-aem-forms-deployments.md)
         + {hide-from-toc}[작업 관리자 및 제한](/help/forms/using/admin-help/manager-throttling.md)
         + {hide-from-toc}[유지 관리 모드에서 AEM 양식 실행](/help/forms/using/admin-help/running-aem-forms-maintenance-mode.md)
      + AEM Forms 데이터베이스 유지 관리 {#maintain-aem-forms-database}
         + {hide-from-toc}[DB2® 데이터베이스: 매주 프로세스 실행](/help/forms/using/admin-help/db2-database-running-process-weekly.md)
         + {hide-from-toc}[Oracle 데이터베이스 최대 열린 커서 임계값](/help/forms/using/admin-help/oracle-database-maximum-open-cursors.md)
         + {hide-from-toc}[® DB2® 데이터베이스: 정기 유지 관리를 위한 명령 실행](/help/forms/using/admin-help/ibm-db2-database-running-commands.md)
         + {hide-from-toc}[프로세스 데이터 제거](/help/forms/using/admin-help/purging-process-data.md)
         + {hide-from-toc}[Microsoft SQL Server 데이터베이스: 구성을 미세 조정](/help/forms/using/admin-help/microsoft-sql-server-database-fine.md)
         + {hide-from-toc}[데이터베이스 증가를 최소화하기 위한 팁](/help/forms/using/admin-help/tips-minimizing-database-growth.md)
      + 애플리케이션 서버 유지 관리 {#manage-application-server}
         + {hide-from-toc}[응용 프로그램 서버 웹 사이트](/help/forms/using/admin-help/application-server-websites.md)
         + {hide-from-toc}[전역 문서 저장소 디렉터리](/help/forms/using/admin-help/global-document-storage-directory.md)
         + {hide-from-toc}[AdministrationConsole을 실행할 때 고려 사항](/help/forms/using/admin-help/considerations-running-administration-console.md)
         + {hide-from-toc}[응용 프로그램 서버 성능 향상](/help/forms/using/admin-help/enhancing-application-server-performance.md)
         + {hide-from-toc}[WebSphere® 응용 프로그램 서버 시작 및 중지](/help/forms/using/admin-help/starting-stopping-websphere-application-server.md)
      + AEM Forms 백업 및 복구 {#aem-forms-backup-recovery}
         + {hide-from-toc}[EMC Documentum® 저장소 백업 및 복구](/help/forms/using/admin-help/backing-recovering-emc-documentum-repository.md)
         + {hide-from-toc}[안전 백업 모드 사용 및 사용 안 함](/help/forms/using/admin-help/enabling-disabling-safe-backup-mode.md)
         + {hide-from-toc}[AEM 양식 데이터 백업](/help/forms/using/admin-help/backing-aem-forms-data.md)
         + {hide-from-toc}[백업 및 복구할 파일](/help/forms/using/admin-help/files-back-recover.md)
         + {hide-from-toc}[AEM 양식을 위한 백업 및 복구 전략](/help/forms/using/admin-help/backup-recovery-strategy-aem-forms.md)
         + {hide-from-toc}[PDF Generator 백업 제한 사항](/help/forms/using/admin-help/pdf-generator-backup-limitations.md)
         + {hide-from-toc}[감시 폴더의 백업 전략](/help/forms/using/admin-help/backup-strategies-watched-folders.md)
         + [AEM Forms 데이터 복구](/help/forms/using/admin-help/recovering-aem-forms-data.md)
         + [EMC Documentum®용 커넥터 사용자를 위한 백업 전략](/help/forms/using/admin-help/backup-strategy-connector-emc-documentum.md)
         + {hide-from-toc}[클러스터된 환경에서 백업 및 복원 전략](/help/forms/using/admin-help/strategy-backup-restore-clustered-environment.md)
      + 시스템 정보 서비스 {#system-information-service}
         + {hide-from-toc}[시스템 정보 서비스 설정](/help/forms/using/admin-help/set-system-information-service.md)
         + {hide-from-toc}[시스템 정보 서비스 API](/help/forms/using/admin-help/system-information-service-apis.md)
   + 프로세스 보고 {#process-reporting}
      + {hide-from-toc}[프로세스 보고 소개](/help/forms/using/process-reporting/introduction-process-reporting.md)
      + {hide-from-toc}[프로세스 보고 시작](/help/forms/using/process-reporting/install-start-process-reporting.md)
      + {hide-from-toc}[프로세스 보고 작동 방식](/help/forms/using/process-reporting/process-reporting-architecture.md)
      + {hide-from-toc}[프로세스 보고에서 미리 정의된 보고서](/help/forms/using/process-reporting/pre-defined-reports-in-process-reporting.md)
      + {hide-from-toc}[보고 중인 사용자 지정 보고서](/help/forms/using/process-reporting/process-reporting-custom-reports.md)
   ...
   + 개발자 참조 {#developer-reference}
      ...
      + JEE에서 AEM Forms를 사용한 프로그래밍 {#programming-aem-forms-jee}
         + JEE에서 AEM Forms를 사용한 프로그래밍 소개 {#introduction-programming-aem-forms-jee}
            ...
            + {hide-from-toc}[API를 사용하여 AEM Forms 호출](/help/forms/developing/invoking-aem-forms-using-apis.md)
            + {hide-from-toc}[AEM Forms 프로세스 이해](/help/forms/developing/aem-forms-processes.md)
            + {hide-from-toc}[서비스 컨테이너](/help/forms/developing/service-container.md)
         + AEM Forms용 SPI 개발 {#developing-spis-aem-forms}
            + {hide-from-toc}[외부 사용자 초대 처리기 만들기](/help/forms/developing/creating-invite-external-users-handler.md)
         + Java API 빠른 시작 - 코드 예시 {#java-api-quick-start-code-examples}
            + {hide-from-toc}[Application Manager 클라이언트 JavaAPI 빠른 시작(SOAP)](/help/forms/developing/application-manager-client-java-api.md)
            + {hide-from-toc}[Application Manager 서비스 JavaAPI 빠른 시작(SOAP)](/help/forms/developing/application-manager-service-java-api.md)
            + {hide-from-toc}[어셈블러 서비스 Java API 빠른 시작(SOAP)](/help/forms/developing/assembler-service-java-api-quick.md)
            + {hide-from-toc}[Acrobat Reader DC 확장 서비스 Java API 빠른 시작(SOAP)](/help/forms/developing/acrobat-reader-dc-extensions-service.md)
            + {hide-from-toc}[백업 및 복원 서비스 APIQuick 시작](/help/forms/developing/backup-restore-service-api-quick.md)
            + {hide-from-toc}[바코드 Forms 서비스 Java APIQuick Start(SOAP)](/help/forms/developing/barcoded-forms-service-java-api.md)
            + {hide-from-toc}[구성 요소 및 서비스 Java APIuick 시작(SOAP)](/help/forms/developing/components-services-java-api-quick.md)
            + {hide-from-toc}[PDF 서비스 Java API 빠른 시작(SOAP) 변환](/help/forms/developing/convert-pdf-service-java-api.md)
            + {hide-from-toc}[자격 증명 서비스 Java API 빠른 시작(SOAP)](/help/forms/developing/credential-service-java-api-quick.md)
            + {hide-from-toc}[Distiller 서비스 Java API 빠른 시작(SOAP)](/help/forms/developing/distiller-service-java-api-quick.md)
            + {hide-from-toc}[DocConverter 서비스 Java API 빠른 시작(SOAP)](/help/forms/developing/docconverter-service-java-api-quick.md)
            + {hide-from-toc}[문서 관리 서비스(더 이상 사용되지 않음)Java API 빠른 시작(SOAP)](/help/forms/developing/document-management-service-deprecated-java.md)
            + {hide-from-toc}[Document Security Service JavaAPI 빠른 시작(SOAP)](/help/forms/developing/document-security-service-java-api.md)
            + {hide-from-toc}[암호화 서비스 Java API 빠른 시작(SOAP)](/help/forms/developing/encryption-service-java-api-quick.md)
            + {hide-from-toc}[Endpoint Registry Java API QuickStart(SOAP)](/help/forms/developing/endpoint-registry-java-api-quick.md)
            + {hide-from-toc}[양식 데이터 통합 서비스 JavaAPI 빠른 시작(SOAP)](/help/forms/developing/form-data-integration-service-java.md)
            + {hide-from-toc}[Forms 서비스 API 빠른 시작](/help/forms/developing/forms-service-api-quick-starts.md)
            + {hide-from-toc}[PDF 서비스 Java API 빠른 시작 생성(SOAP)](/help/forms/developing/generate-pdf-service-java-api.md)
            + {hide-from-toc}[호출 API 빠른 시작](/help/forms/developing/invocation-api-quick-starts.md)
            + {hide-from-toc}[LiveCycleProcess Java API(SOAP)빠른 시작](/help/forms/developing/livecycleprocess-java-api-soap-quick.md)
            + {hide-from-toc}[출력 서비스 Java API 빠른 시작(SOAP)](/help/forms/developing/output-service-java-api-quick.md)
            + {hide-from-toc}[PDF 유틸리티 서비스 Java APIQuick 시작(SOAP)](/help/forms/developing/pdf-utilities-service-java-api.md)
            + {hide-from-toc}[저장소 서비스 API 빠른 시작](/help/forms/developing/repository-service-api-quick-starts.md)
            + {hide-from-toc}[서명 서비스 Java API 빠른 시작(SOAP)](/help/forms/developing/signature-service-java-api-quick.md)
            + {hide-from-toc}[작업 관리자 서비스 Java API 빠른 시작(SOAP)](/help/forms/developing/task-manager-service-java-api.md)
            + {hide-from-toc}[사용자 관리자 Java API 빠른 시작(SOAP)](/help/forms/developing/user-manager-java-api-quick.md)
            + {hide-from-toc}[XMP 유틸리티 서비스 Java APIQuick 시작(SOAP)](/help/forms/developing/xmp-utilities-service-java-api.md)
         + API를 사용하여 JEE에서 AEM Forms 호출 {#invoking-aem-forms-jee-apis}
            + {hide-from-toc}[REST 요청을 사용하여 AEM Forms 호출](/help/forms/developing/invoking-aem-forms-using-rest.md)
            + {hide-from-toc}[웹 서비스를 사용하여 AEM Forms 호출](/help/forms/developing/invoking-aem-forms-using-web.md)
            + {hide-from-toc}[원격을 사용하여 AEM Forms 호출](/help/forms/developing/invoking-aem-forms-using-remoting.md)
            + {hide-from-toc}[웹 서비스를 사용하여 AEM Forms 호출](/help/forms/developing/invoking-human-centric-long-lived.md)
            + {hide-from-toc}[JavaAPI를 사용하여 AEM Forms 호출](/help/forms/developing/invoking-aem-forms-using-java.md)
            + {hide-from-toc}[HTTP 토큰을 사용하여 SSO 인증을 수행하는 Flash Builder 응용 프로그램을 만드는 중](/help/forms/developing/creating-flash-builder-applications-perform.md)
         + API를 사용하여 서비스 작업 수행 {#performing-service-operations-using-apis}
            + {hide-from-toc}[API를 사용하여 서비스 작업 수행](/help/forms/developing/performing-service-operations-using-apis.md)
            + {hide-from-toc}[Forms 렌더링](/help/forms/developing/rendering-forms.md)
            + {hide-from-toc}[PDF 문서 어셈블](/help/forms/developing/assembling-pdf-documents.md)
            + {hide-from-toc}[프로그래밍 방식으로 PDF 문서 어셈블](/help/forms/developing/programmatically-assembling-pdf-documents.md)
            + {hide-from-toc}[파일 형식과 PDF 간 변환](/help/forms/developing/converting-file-formats-pdf.md)
            + {hide-from-toc}[프로그래밍 방식으로 PDF 문서 디스어셈블](/help/forms/developing/programmatically-disassembling-pdf-documents.md)
            + {hide-from-toc}[암호화된 PDF 문서 어셈블](/help/forms/developing/assembling-encrypted-pdf-documents.md)
            + {hide-from-toc}[여러 XDP 조각 어셈블](/help/forms/developing/assembling-multiple-xdp-fragments.md)
            + {hide-from-toc}[Bates 번호 매기기를 사용하여 문서 어셈블](/help/forms/developing/assembling-documents-using-bates-numbering.md)
            + {hide-from-toc}[비대화형 PDF 문서 어셈블](/help/forms/developing/assembling-non-interactive-pdf-documents.md)
            + {hide-from-toc}[책갈피로 PDF 문서 어셈블](/help/forms/developing/assembling-pdf-documents-bookmarks.md)
            + {hide-from-toc}[사용 권한 할당](/help/forms/developing/assigning-usage-rights.md)
            + {hide-from-toc}[PDF 포트폴리오 어셈블](/help/forms/developing/assembling-pdf-portfolios.md)
            + {hide-from-toc}[양식 데이터 계산](/help/forms/developing/calculating-form-data.md)
            + {hide-from-toc}[Forms을 렌더링하는 웹 응용 프로그램을 만드는 중](/help/forms/developing/creating-web-applications-renders-forms.md)
            + {hide-from-toc}[SubmittedXML 데이터를 사용하여 PDF 문서 만들기](/help/forms/developing/creating-pdf-documents-submitted-xml.md)
            + {hide-from-toc}[웹 서비스 API를 사용하여 PDF 문서를 디스어셈블합니다](/help/forms/developing/disassemble-pdf-document-using-web.md)
            + {hide-from-toc}[문서가 PDF/A와 호환되는지 확인](/help/forms/developing/determining-whether-documents-pdf-a.md)
            + {hide-from-toc}[동적으로 DDX 문서 만들기](/help/forms/developing/dynamically-creating-ddx-documents.md)
            + {hide-from-toc}[제출된 Forms 처리](/help/forms/developing/handling-submitted-forms.md)
            + {hide-from-toc}[Forms 서비스의 성능 최적화](/help/forms/developing/optimizing-performance-forms-service.md)
            + {hide-from-toc}[FormsService에 문서 전달](/help/forms/developing/passing-documents-forms-service.md)
            + {hide-from-toc}[유동성 레이아웃으로 Forms 미리 채우기](/help/forms/developing/prepopulating-forms-flowable-layouts.md)
            + {hide-from-toc}[조각을 기반으로 Forms 렌더링](/help/forms/developing/rendering-forms-based-fragments.md)
            + {hide-from-toc}[값별 Forms 렌더링](/help/forms/developing/rendering-forms-value.md)
            + {hide-from-toc}[Forms을 HTML으로 렌더링](/help/forms/developing/rendering-forms-html.md)
            + {hide-from-toc}[클라이언트에서 Forms 렌더링](/help/forms/developing/rendering-forms-client.md)
            + {hide-from-toc}[사용자 지정 CSS 파일을 사용하여 HTML Forms 렌더링](/help/forms/developing/rendering-html-forms-using-custom.md)
            + {hide-from-toc}[CustomToolbars를 사용하여 HTML Forms 렌더링](/help/forms/developing/rendering-html-forms-custom-toolbars.md)
            + {hide-from-toc}[대화형 PDF forms 렌더링](/help/forms/developing/rendering-interactive-pdf-forms.md)
            + {hide-from-toc}[렌더링 권한이 활성화된 Forms](/help/forms/developing/rendering-rights-enabled-forms.md)
            + {hide-from-toc}[DDX 문서 확인](/help/forms/developing/validating-ddx-documents.md)
            + {hide-from-toc}[PDF을 Postscript 및 이미지 파일로 변환](/help/forms/developing/converting-pdf-postscript-image-files.md)
            + {hide-from-toc}[Postscript를 PDF 문서로 변환](/help/forms/developing/converting-postscript-pdf-documents.md)
            + {hide-from-toc}[문서 출력 스트림 만들기](/help/forms/developing/creating-document-output-streams.md)
            + {hide-from-toc}[디지털 서명 및 인증 문서](/help/forms/developing/digitally-signing-certifying-documents.md)
            + {hide-from-toc}[PDF 문서 암호화 및 암호 해독](/help/forms/developing/encrypting-decrypting-pdf-documents.md)
            + {hide-from-toc}[데이터 가져오기 및 내보내기](/help/forms/developing/importing-exporting-data.md)
            + {hide-from-toc}[사용자 관리](/help/forms/developing/users.md)
            + {hide-from-toc}[AEM Forms 저장소를 사용하여 작업](/help/forms/developing/aem-forms-repository.md)
            + {hide-from-toc}[바코드 Forms 작업](/help/forms/developing/barcoded-forms.md)
            + {hide-from-toc}[자격 증명으로 작업](/help/forms/developing/credentials.md)
            + {hide-from-toc}[PDF/A 문서 작업](/help/forms/developing/pdf-a-documents.md)
            + {hide-from-toc}[PDF 유틸리티 작업](/help/forms/developing/pdf-utilities.md)
            + {hide-from-toc}[XMP 유틸리티 작업](/help/forms/developing/xmp-utilities.md)
            + {hide-from-toc}[백업을 위해 AEM Forms 준비 중](/help/forms/developing/preparing-aem-forms-backup.md)
            + {hide-from-toc}[프로그래밍 방식으로 끝점 관리](/help/forms/developing/programmatically-endpoints.md)
            + {hide-from-toc}[프로그래밍 방식으로 환경 설정 노드 관리](/help/forms/developing/programmatically-preferences-nodes.md)
            + {hide-from-toc}[정책으로 문서 보호](/help/forms/developing/protecting-documents-policies.md)
            + {hide-from-toc}[웹 서비스 API를 사용하여 DDX 문서 유효성 검사](/help/forms/developing/validate-ddx-document-using-web.md)
   + 문제 해결 {#troubleshooting}
      ...
      + {hide-from-toc}[JEE의 적응형 Forms 버전에 대한 첨부 파일이 있는 전자 메일을 가져오는 추가 단계](/help/forms/using/additional-steps-to-use-email-with-attachments.md)
      + {hide-from-toc}[Windows Server에서 Word 또는 Excel 파일을 PDF으로 변환할 수 없음](/help/forms/using/disable-uac-for-pdfgconfiguration.md)
      + {hide-from-toc}[Google Chrome, Firefox, Microsoft Edge, Microsoft Internet Explorer 또는 Apple Safari에서 XFA 기반 PDF forms을 열 수 없습니다](/help/forms/using/xfa-based-forms-in-chrome-firefox-ie-internet-explorter-safari-edge.md)
      + {hide-from-toc}[CRX 저장소를 복원할 수 없습니다](/help/forms/using/restore-crx-repository.md)
      + {hide-from-toc}[AEM Forms 서버가 완전히 실행되고 있지 않더라도 문서 처리](/help/forms/using/processing-documents-even-if-aem-forms-server-not-fully-up.md)
      + {hide-from-toc}[출력 서비스, Forms 서비스 또는 DoR(Document of Record) 서비스를 사용할 수 없음](/help/forms/using/connection-issues-with-output-forms-and-document-of-record-dor-services.md)
      + {hide-from-toc}[PDF 생성이 WorkBench에서 많은 수의 PDF를 인쇄하지 못함](/help/forms/using/pdf-generation-service-fails-to-print-a-large-number-of-pdfs-on-workbench.md)
      + {hide-from-toc}[AEM SDK을 올바르게 다시 시작하는 방법](/help/forms/using/restart-aem-sdk.md)
   ...
   + 이전 설명서 {#legacy-documentation}
      ...
      + {hide-from-toc}[JEE 서버 클러스터에서 AEM Forms 구성 및 문제 해결](/help/forms/developing/configure-server-cluster.md)
      + {hide-from-toc}[동적 PDF forms에서 해시 생성 및 작업](/help/forms/developing/hashing-forms.md)
      + {hide-from-toc}[WS-Security 헤더를 사용하여 자격 증명 전달](/help/forms/developing/passing-credentials.md)
+ AEM의 AI {#ai-in-aem}
...
+ 구현 {#implementing}
   + 개발 {#developing}
      ...
      + 모범 사례 {#bestpractices}
         ...
         + [사용자 정의 네임스페이스](/help/sites-developing/custom-namespaces.md)
   ...
   + 배포 {#deploying}
      ...
      + AEM 배포 {#deploying}
         ...
         + [AEM에 대한 오프라인 리인덱싱](/help/sites-deploying/offline-reindexing.md)
      ...
      + AEM 구성 {#configuring}
         ...
         + {hide-from-toc}[버전 제거](/help/sites-deploying/version-purging.md)
      ...
      + AEM 6.5 LTS로 업그레이드 {#upgrading}
         ...
         + {hide-from-toc}[패턴 감지기를 사용하여 업그레이드 복잡성 평가](/help/sites-deploying/pattern-detector.md)
         + [AEM Analyzer를 사용한 업그레이드 복잡성 평가](/help/sites-deploying/aem-analyzer.md)
         + {hide-from-toc}[AEM 6.5 LTS의 이전 버전과의 호환성](/help/sites-deploying/backward-compatibility.md)
         + [업그레이드 절차](/help/sites-deploying/upgrade-procedure.md)
         + [인플레이스 업그레이드 수행](/help/sites-deploying/in-place-upgrade.md)
         + {hide-from-toc}[지연 콘텐츠 마이그레이션](/help/sites-deploying/lazy-content-migration.md)
         + {hide-from-toc}[CRX2Oak 마이그레이션 도구 사용](/help/sites-deploying/using-crx2oak.md)
         ...
         + {hide-from-toc}[사용자 지정 검색 Forms 업그레이드](/help/sites-deploying/upgrading-custom-search-forms.md)
         + {hide-from-toc}[지속 가능한 업그레이드](/help/sites-deploying/sustainable-upgrades.md)
