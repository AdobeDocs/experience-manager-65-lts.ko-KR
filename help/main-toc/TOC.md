...
+ Sites {#sites}
   ...
   + 관리 {#administering}
      ...
      + 모범 사례 {#bestpractices}
         ...
         + [AEM Commerce - GDPR 준비](/help/sites-administering/gdpr-compliance-commerce.md)
...
+ Forms {#forms}
   ...
   + 적응형 양식 - 기본 작성 {#adaptive-forms-basic-authoring}
      ...
      + [적응형 폼 구성 요소의 인라인 스타일 지정](/help/forms/using/inline-style-adaptive-forms.md)
   ...
   + 워크플로 {#workflows}
      ...
      + [AEM 워크플로에서 Document Services API 시작](/help/forms/using/initiating-document-services-apis-aem.md)
   ...
   + AEM Forms 앱 {#aem-forms-app}
      ...
      + [Android 설정](/help/forms/using/setup-android-studio-project-build-installer.md)
      + [AEM Forms Android 빌드](/help/forms/using/setup-eclipse-project-build-installer.md)
   ...
   + 레터와 서신 {#letters-correspondences}
      ...
      + [레터 및 인터랙티브 커뮤니케이션의 사후 처리](/help/forms/using/submit-letter-topostprocess.md)
      ...
      + [레터 PDF 미리 보기의 사용자 정의 워터마크](/help/forms/using/custom-watermark.md)
      + [서신 관리 솔루션 구성](/help/forms/using/configuring-a-cm-solution.md)
      + [인터랙티브 커뮤니케이션 및 레터의 인라인 조건 및 반복](/help/forms/using/cm-inline-condition.md)
   ...
   + AEM Forms를 Experience Cloud 솔루션과 통합 {#integrate-aem-forms-with-experience-cloud-solutions}
      ...
      + [Adobe Launch를 사용한 분석](/help/forms/using/integrate-aem-forms-with-adobe-analytics.md)
   ...
   + JEE의 AEM Forms에 대한 관리자 도움말 {#administrator-help}
      ...
      + 콘텐츠 관리 시스템에 연결 {#connect-content-management-system}
         ...
         + [IBM용 커넥터 구성](/help/forms/using/admin-help/configuring-connector-ibm-filenet.md)
         + [IBM용 커넥터 구성](/help/forms/using/admin-help/configuring-connector-ibm-content-manager.md)
      ...
      + SSL 구성 {#configure-ssl}
         ...
         + [JBoss용 SSL 구성](/help/forms/using/admin-help/configuring-ssl-jboss-application-server.md)
         + [Windows Vista에서 SSL 구성](/help/forms/using/admin-help/configuring-ssl-windows-vista.md)
         + [WebSphere에 대한 SSL 구성](/help/forms/using/admin-help/configuring-ssl-websphere-application-server.md)
      ...
      + Output 구성 {#configure-output}
         + [Output 서비스 개요](/help/forms/using/admin-help/overview-8.md)
         + [XCI 구성 옵션 지정](/help/forms/using/admin-help/specify-xci-configuration-options.md)
         + [Output에 대한 캐싱 구성](/help/forms/using/admin-help/configuring-caching-output.md)
         + [Output 파일 위치 지정](/help/forms/using/admin-help/specify-file-locations-output.md)
      ...
      + 애플리케이션 서버 유지 관리 {#manage-application-server}
         ...
         + [WebSphere 시작 및 중지](/help/forms/using/admin-help/starting-stopping-websphere-application-server.md)
      + AEM Forms 백업 및 복구 {#aem-forms-backup-recovery}
         + [EMC Documentum 백업 및 복구](/help/forms/using/admin-help/backing-recovering-emc-documentum-repository.md)
         ...
         + [Connector for EMC Documentum 백업 전략](/help/forms/using/admin-help/backup-strategy-connector-emc-documentum.md)
   ...
   + 개발자 참조 {#developer-reference}
      ...
      + [적응형 양식에 대한 JavaScript 라이브러리 API 참조](https://helpx.adobe.com/kr/experience-manager/6-5/forms/javascript-api/index.html)
      ...
      + JEE에서 AEM Forms를 사용한 프로그래밍 {#programming-aem-forms-jee}
         ...
         + Java API 빠른 시작 - 코드 예시 {#java-api-quick-start-code-examples}
            ...
            + [Barcoded Forms Service Java API 빠른 시작(SOAP)](/help/forms/developing/barcoded-forms-service-java-api.md)
            ...
            + [Output 서비스 Java API 빠른 시작(SOAP)](/help/forms/developing/output-service-java-api-quick.md)
         ...
         + API를 사용하여 서비스 작업 수행 {#performing-service-operations-using-apis}
            ...
            + [PDF 문서 어셈블하기](/help/forms/developing/assembling-pdf-documents.md)
            + [프로그래밍 방식으로 PDF 문서 어셈블하기](/help/forms/developing/programmatically-assembling-pdf-documents.md)
            + [파일 형식과 PDF 간 변환](/help/forms/developing/converting-file-formats-pdf.md)
            + [프로그래밍 방식으로 PDF 문서 디스어셈블하기](/help/forms/developing/programmatically-disassembling-pdf-documents.md)
            + [암호화된 PDF 문서 어셈블하기](/help/forms/developing/assembling-encrypted-pdf-documents.md)
            + [여러 XDP 조각 어셈블하기](/help/forms/developing/assembling-multiple-xdp-fragments.md)
            + [Bates 번호 매기기를 사용하여 문서 어셈블하기](/help/forms/developing/assembling-documents-using-bates-numbering.md)
            + [비대화형 PDF 문서 어셈블하기](/help/forms/developing/assembling-non-interactive-pdf-documents.md)
            + [책갈피를 사용하여 PDF 문서 어셈블하기](/help/forms/developing/assembling-pdf-documents-bookmarks.md)
            + [사용 권한 할당](/help/forms/developing/assigning-usage-rights.md)
            + [PDF 포트폴리오 어셈블하기](/help/forms/developing/assembling-pdf-portfolios.md)
            ...
            + [Barcoded Forms 작업](/help/forms/developing/barcoded-forms.md)
   ...
   + 문제 해결 {#troubleshooting}
      ...
      + [Output 서비스, Forms 서비스, 기록 문서(DoR) 서비스를 사용할 수 없음](/help/forms/using/connection-issues-with-output-forms-and-document-of-record-dor-services.md)
...
+ Headless {#headless}
   ...
   + [설명서 여정이란 무엇입니까?](/help/journey-documentation/home.md)
+ 구현 {#implementing}
   + 개발 {#developing}
      ...
      + 헤드리스 환경 관리 {#headless}
         ...
         + Headless 여정 {#journeys}
            + Headless 개발자 여정 {#developer}
               + [AEM 헤드리스 이해](https://experienceleague.adobe.com/docs/experience-manager-65-lts/content/headless/developer/overview.html?lang=ko)
               ...
               + [Headless 애플리케이션 실행 방법](https://experienceleague.adobe.com/docs/experience-manager-65-lts/content/headless/developer/go-live.html?lang=ko)
               + [선택 사항 - AEM을 통해 단일 페이지 애플리케이션을 제작하는 방법](https://experienceleague.adobe.com/docs/experience-manager-65-lts/content/headless/developer/create-spa.html?lang=ko)
            + Headless 콘텐츠 설계 여정 {#architect}
               + [AEM Headless 콘텐츠 설계 여정 개요](https://experienceleague.adobe.com/docs/experience-manager-65-lts/content/headless/architect/overview.html?lang=ko)
               + [AEM을 통한 Headless용 콘텐츠 모델링 - 소개](https://experienceleague.adobe.com/docs/experience-manager-65-lts/content/headless/architect/introduction.html?lang=ko)
         ...
         + 콘텐츠 조각{#content-fragments}
            ...
            + [미리보기 - JSON 표시](https://experienceleague.adobe.com/docs/experience-manager-65-lts/content/assets/content-fragments/content-fragments-json-preview.html?lang=ko)
         + 배달 API{#delivery-api}
            + [자산 HTTP API](https://experienceleague.adobe.com/docs/experience-manager-65-lts/content/assets/extending/mac-api-assets.html?lang=ko)
            ...
            + [콘텐츠 조각 GraphQL API](https://experienceleague.adobe.com/docs/experience-manager-65-lts/content/assets/extending/graphql-api-content-fragments.html?lang=ko)
            ...
            + [콘텐츠 조각의 원격 AEM GraphQL 구문 인증](https://experienceleague.adobe.com/docs/experience-manager-65-lts/content/assets/extending/graphql-authentication-content-fragments.html?lang=ko)
            + [콘텐츠 조각이 있는 AEM GraphQL API - 샘플 콘텐츠 및 구문](https://experienceleague.adobe.com/docs/experience-manager-65-lts/content/assets/extending/content-fragments-graphql-samples.html?lang=ko)
      ...
      + 개인화 {#personlization}
         ...
         + [타깃팅된 콘텐츠를 위한 개발](/help/sites-developing/target.md)
      ...
      + AEM 확장 {#extending-aem}
         ...
         + 워크플로 확장{#extending-workflows}
            ...
            + [워크플로 우수 사례](/help/sites-developing/workflows-best-practices.md)
      ...
      + 테스트 {#testing}
         ...
         + [확인 목록](/help/sites-developing/checklists.md)
      ...
      + 모범 사례 {#bestpractices}
         ...
         + We.Retail 참조 구현{#we-retail}
            ...
            + [We.Retail에서 콘텐츠 조각 시험 사용](/help/sites-developing/we-retail-content-fragments.md)
