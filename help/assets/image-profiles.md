...
생성하는 각 스마트 자르기 생성에는 추가 처리가 필요합니다. 예를 들어 5개 이상의 스마트 자르기 종횡비를 추가하면 에셋 수집률이 느려질 수 있습니다. 또한 시스템의 부하가 증가합니다. 폴더 수준에서 스마트 자르기를 적용할 수 있으므로 필요한 *폴더*&#x200B;에서만 사용하는 것이 좋습니다.
