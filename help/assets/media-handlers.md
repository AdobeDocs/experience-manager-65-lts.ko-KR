...
* ImageMagick(`https://www.imagemagick.org/script/index.php` 웹 사이트) 및 [Ghostscript](https://www.ghostscript.com/)를 사용한 EPS 및 AI 변환.
...
1. [!DNL ImageMagick] 설치: `https://www.imagemagick.org/script/download.php` 웹 사이트에서 ImageMagick 설명서를 참조하십시오.
