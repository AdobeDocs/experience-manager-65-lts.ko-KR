...
| | When | 일회성 또는 반복을 선택합니다. 반복 작업을 설정하려면 반복 옵션(일별, 주별, 월별 또는 사용자 지정)을 선택하여 FTP 업로드 작업이 반복될 시기를 지정합니다. 그런 다음 필요에 따라 예약 옵션을 지정합니다. |
...
1. 오른쪽 상단의 옵션을 사용하여 PDFPDF 에서 ![다운로드 옵션](assets/do-not-localize/download.png) 또는 ![인쇄 옵션](assets/do-not-localize/print.png)을(를) PDF에서 다운로드합니다.
