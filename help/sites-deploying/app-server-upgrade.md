---
title: 애플리케이션 서버 설치를 위한 업그레이드 단계
...
# 애플리케이션 서버 설치를 위한 업그레이드 단계 {#upgrade-steps-for-application-servers}
...
* [JBOSS EAP 8(windows)의 AEM 6.5 LTS 업그레이드 단계](/help/forms/using/upgrading-aem-65-lts-on-jboss-eap-8.md)
