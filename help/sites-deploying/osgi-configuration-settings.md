...
**Apache Sling 큐 구성** 작업 일정을 관리하는 매개 변수를 구성합니다.

* **다시 시도 간격**, **최대 다시 시도**, **최대 병렬 작업**.
...
**Apache Sling Commons MIME 유형 서비스** 구성:
...
**Adobe Granite HTTP 헤더 인증 처리기** HTTP 요청의 기본 인증 방법에 대한 시스템 전체 설정입니다.
