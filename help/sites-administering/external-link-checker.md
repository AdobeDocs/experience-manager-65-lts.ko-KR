...
* `/content/wknd/us/en/adventures/extreme-ironing.html`텍스트 구성 요소에 [에 대한 링크를 포함합니다.](https://experienceleague.adobe.com/docs/experience-manager-core-components/using/components/text.html)
...
* 내 페이지 `/content/wknd/us/en/adventures/ski-touring.html`
* `https://bunwarmerthermalunderwear.com`텍스트 구성 요소에 [에 대한 링크를 포함합니다.](https://experienceleague.adobe.com/docs/experience-manager-core-components/using/components/text.html)
