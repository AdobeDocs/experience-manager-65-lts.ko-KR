...
1. 처음 액세스할 때 시스템에서는 **콘텐츠 작성자** 사전 설정(페이지의 오른쪽 상단 근처에 표시됨)을 할당합니다. 위젯, 탐색 항목 및 표시되는 콘텐츠를 제어합니다.
   ...
   ![선택한 콘텐츠 작성자를 표시하는 사전 설정 드롭다운 목록](/help/assets/assets-experience-hub/experience-hub-role-selection.png)
...
이러한 기능은 액세스할 수 있는 기본 프로덕션 환경에서 사용할 수 있습니다. 또는 여러 AEM 인스턴스에 액세스할 수 있는 경우 타기팅할 특정 환경을 선택할 수 있습니다.

![프로덕션 및 스테이징 환경](/help/assets/assets-experience-hub/experience-hub-prod-stage-ams.png)

Adobe Experience Manager의 중앙 허브 역할을 하는 Experience Hub 페이지는 각 사용자 역할에 맞춘 추가 위젯과 액션을 제공하도록 확장됩니다. 완전히 사용자 정의할 수 있는 이 페이지를 통해 화면에 최적의 레이아웃을 선택할 수 있습니다. 위젯은 선택된 항목만 주 페이지에 표시되도록 필터링할 수 있어 개인화된 환경을 유지할 수 있습니다.
