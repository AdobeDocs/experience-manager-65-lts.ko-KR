---
title: Adobe Content Package Maven 플러그인
...
# Adobe Content Package Maven 플러그인 {#adobe-content-package-maven-plugin}

Adobe Content Package Maven 플러그인을 사용하여 패키지 배포 및 관리 작업을 Maven 프로젝트에 통합합니다.

Adobe Content Package Maven 플러그인은 구성된 패키지를 AEM에 배포하고 AEM Package Manager에서 일반적으로 수행하는 작업을 자동화합니다.
