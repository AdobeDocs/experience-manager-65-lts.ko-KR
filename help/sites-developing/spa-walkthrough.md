...
>
>모든 AEM 프로젝트에서는 React 또는 Angular을 사용하는 SPA 프로젝트를 지원하고 SPA SDK를 사용하는 [AEM 프로젝트 Archetype](https://experienceleague.adobe.com/docs/experience-manager-core-components/using/developing/archetype/overview.html)을 사용해야 합니다.
