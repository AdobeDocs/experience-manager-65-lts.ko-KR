...
>[!TIP]
>
>범용 편집기를 시작하는 개발자를 위한 포괄적인 안내서는 이 섹션에서 언급한 대로 AEM 6.5 LTS 지원에 필요한 변경 사항을 염두에 두고 AEM as a Cloud Service 설명서의 [AEM 개발자를 위한 범용 편집기 개요](https://experienceleague.adobe.com/ko/docs/experience-manager-cloud-service/content/implementing/developing/universal-editor/developer-overview) 문서를 참조하십시오.
