...
<table>
 <tbody>
  ...
  <tr>
   ...
   <td>JCR 노드 기반(<code>nt:file</code> 또는 <code>nt:resource</code>), 번들 리소스 또는 파일 시스템 리소스인 경우 파일 리소스의 이진 콘텐츠를 반환합니다. 이진 JCR 속성 리소스의 데이터를 반환합니다.</td>
  </tr>
  <tr>
   <td><a href="https://docs.oracle.com/javase/1.5.0/docs/api/java/net/URL.html">URL</a></td>
   <td>리소스에 대한 URL을 반환합니다. JCR 노드 기반 리소스의 저장소 URL, 번들 리소스의 JAR 번들 URL 또는 파일 시스템 리소스의 파일 URL을 반환합니다.</td>
  </tr>
  <tr>
